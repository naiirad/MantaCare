...
const Impressum = () => {
  return (
    <div className="impressum-container p-16">
      <h1 style={{ fontWeight: "bold", fontSize: "30px" }}>Impressum</h1>
      <p> </p>
      ...
      <h3 style={{ fontWeight: "bold", fontSize: "24x" }}>Haftung für Inhalte</h3>
      <p>
      ...
      <h3 style={{ fontWeight: "bold", fontSize: "24x" }}>Haftung für Links</h3>
      <p>
      ...
      <h3 style={{ fontWeight: "bold", fontSize: "24x" }}>Urheberrecht</h3>
      <p>
      ...
      <h3 style={{ fontWeight: "bold", fontSize: "24x" }}>Datenschutz</h3>
      <p>
